(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("mocha"), require("d3-selection"), require("underscore"), require("chai"), require("d3-drag"), require("d3-format"), require("d3-zoom"), require("d3-request"), require("d3-scale"), require("baconjs"), require("mousetrap"), require("d3-brush"), require("tinier"), require("jsdom"), require("vkbeautify"), require("d3-dsv"), (function webpackLoadOptionalExternalModule() { try { return require("file-saver"); } catch(e) {} }()), require("assert"));
	else if(typeof define === 'function' && define.amd)
		define(["mocha", "d3-selection", "underscore", "chai", "d3-drag", "d3-format", "d3-zoom", "d3-request", "d3-scale", "baconjs", "mousetrap", "d3-brush", "tinier", "jsdom", "vkbeautify", "d3-dsv", "file-saver", "assert"], factory);
	else if(typeof exports === 'object')
		exports["escher"] = factory(require("mocha"), require("d3-selection"), require("underscore"), require("chai"), require("d3-drag"), require("d3-format"), require("d3-zoom"), require("d3-request"), require("d3-scale"), require("baconjs"), require("mousetrap"), require("d3-brush"), require("tinier"), require("jsdom"), require("vkbeautify"), require("d3-dsv"), (function webpackLoadOptionalExternalModule() { try { return require("file-saver"); } catch(e) {} }()), require("assert"));
	else
		root["escher"] = factory(root["mocha"], root["d3-selection"], root["underscore"], root["chai"], root["d3-drag"], root["d3-format"], root["d3-zoom"], root["d3-request"], root["d3-scale"], root["baconjs"], root["mousetrap"], root["d3-brush"], root["tinier"], root["jsdom"], root["vkbeautify"], root["d3-dsv"], root["file-saver"], root["assert"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_12__, __WEBPACK_EXTERNAL_MODULE_15__, __WEBPACK_EXTERNAL_MODULE_16__, __WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_20__, __WEBPACK_EXTERNAL_MODULE_24__, __WEBPACK_EXTERNAL_MODULE_35__, __WEBPACK_EXTERNAL_MODULE_36__, __WEBPACK_EXTERNAL_MODULE_37__, __WEBPACK_EXTERNAL_MODULE_61__) {
...
var vkbeautify = __webpack_require__(35);
var _ = __webpack_require__(3);
var d3_json = __webpack_require__(12).json;
var d3_text = __webpack_require__(12).text;
var d3_csvParseRows = __webpack_require__(36).csvParseRows;
var d3_selection = __webpack_require__(2).selection;

try {
  var saveAs = __webpack_require__(37).saveAs;
} catch (e) {
...
var d3_select = __webpack_require__(2).select;
...
var utils = __webpack_require__(1);
var data_styles = __webpack_require__(7);
...
var testsContext = __webpack_require__(22);
...
var map = {
	"./test_Behavior.js": 23,
	"./test_Brush.js": 25,
	"./test_BuildInput.js": 26,
	"./test_Builder.js": 27,
	"./test_CallbackManager.js": 62,
	"./test_Canvas.js": 63,
	"./test_CobraModel.js": 64,
	"./test_DataMenu.js": 65,
	"./test_DirectionArrow.js": 66,
	"./test_Draw.js": 67,
	"./test_KeyManager.js": 68,
	"./test_Map.js": 70,
	"./test_SearchIndex.js": 71,
	"./test_Settings.js": 72,
	"./test_UndoStack.js": 73,
	"./test_ZoomContainer.js": 74,
	"./test_data_styles.js": 75,
	"./test_main.js": 76,
	"./test_utils.js": 77
};
...
var require_helper = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./helpers/require_helper\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

var Behavior = require_helper('Behavior');

var describe = __webpack_require__(0).describe;
var it = __webpack_require__(0).it;
var beforeEach = __webpack_require__(0).beforeEach;
var assert = __webpack_require__(4).assert;

var d3_body = __webpack_require__(5);
...
var require_helper = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./helpers/require_helper\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var d3_body = __webpack_require__(5);
var get_map = __webpack_require__(8);
var Brush = require_helper('Brush');
...
function getMap() {
                           var svg = d3_body.append('svg');
                           var sel = svg.append('g');
                           // streams are required for these options
                           var required_options = { reaction_scale: [],
                                                      metabolite_scale: [],
                                                      reaction_styles: [],
                                                      ...
                                                      cofactors: [] };
                           var required_conditional_options = ['reaction_scale', 'metabolite_scale'];
                           var set_option = function set_option(key, val) {
                                                      required_options[key] = val;
                           };
                           var get_option = function get_option(key) {
                                                      return required_options[key];
                           };

                           return Map.from_data(get_map(), svg, null, sel, null, new Settings(set_option, get_option, required_conditional_options), null, true);
}
...
var get_map = __webpack_require__(8);
var get_model = __webpack_require__(60);

var describe = __webpack_require__(0).describe;
var it = __webpack_require__(0).it;
var mocha = __webpack_require__(0);
...
var _builderEmbed = __webpack_require__(34);
...
var utils = __webpack_require__(1);
var BuildInput = __webpack_require__(38);
var ZoomContainer = __webpack_require__(41);
var Map = __webpack_require__(42);
var CobraModel = __webpack_require__(17);
var Brush = __webpack_require__(50);
var CallbackManager = __webpack_require__(6);
var ui = __webpack_require__(51);
var SearchBar = __webpack_require__(52);
var Settings = __webpack_require__(53);
var SettingsMenu = __webpack_require__(54);
var TextEditInput = __webpack_require__(56);
var QuickJump = __webpack_require__(57);
var data_styles = __webpack_require__(7);
var TooltipContainer = __webpack_require__(58);
var DefaultTooltip = __webpack_require__(59).DefaultTooltip;
var _ = __webpack_require__(3);
var d3_select = __webpack_require__(2).select;
var d3_selection = __webpack_require__(2).selection;
var d3_json = __webpack_require__(12).json;
...
var utils = __webpack_require__(1);
var PlacedDiv = __webpack_require__(13);
var completely = __webpack_require__(39);
var DirectionArrow = __webpack_require__(40);
var CobraModel = __webpack_require__(17);
var _ = __webpack_require__(3);
var d3_select = __webpack_require__(2).select;
var d3_mouse = __webpack_require__(2).mouse;
...
var utils = __webpack_require__(1);
var d3_drag = __webpack_require__(9).drag;
var d3_mouse = __webpack_require__(2).mouse;
var d3_selection = __webpack_require__(2);
...
var CallbackManager = __webpack_require__(6);
var _ = __webpack_require__(3);
var d3_zoom = __webpack_require__(11).zoom;
var d3_zoomTransform = __webpack_require__(11).zoomTransform;
var d3_zoomIdentity = __webpack_require__(11).zoomIdentity;
var d3_select = __webpack_require__(2).select;
var d3_selection = __webpack_require__(2);
...
var utils = __webpack_require__(1);
var Draw = __webpack_require__(43);
var Behavior = __webpack_require__(44);
var Scale = __webpack_require__(45);
var build = __webpack_require__(14);
var UndoStack = __webpack_require__(46);
var CallbackManager = __webpack_require__(6);
var KeyManager = __webpack_require__(47);
...
var utils = __webpack_require__(1);
var d3_scaleLinear = __webpack_require__(15).scaleLinear;
var d3_format = __webpack_require__(10).format;
...
var utils = __webpack_require__(1);
var d3_brush = __webpack_require__(19).brush;
var d3_brushSelection = __webpack_require__(19).brushSelection;
var d3_scaleIdentity = __webpack_require__(15).scaleIdentity;
var d3_selection = __webpack_require__(2);
var d3_select = __webpack_require__(2).select;
...
var utils = __webpack_require__(1);
var CallbackManager = __webpack_require__(6);
var ScaleEditor = __webpack_require__(55);
...
var utils = __webpack_require__(1);
var PlacedDiv = __webpack_require__(13);
var tinier = __webpack_require__(20);
var _ = __webpack_require__(3);
...
describe('CobraModel', function () {
  ...
  it('Formulas, genes, reversibility', function () {
    ...
    var model = CobraModel.from_cobra_json(model_data);
    assert.deepEqual(model.reactions, { acc_tpp: { bigg_id: 'acc_tpp',
    ...
    assert.deepEqual(model.metabolites, { acc_c: { bigg_id: 'acc_c',
        formula: 'C3H2' },
      acc_p: { bigg_id: 'acc_p',
        formula: 'C3H2' }
    });
...
describe('DataMenu', function () {
  it('initializes', function () {
    ...
    var data_menu = new DataMenu({ selection: sel });
    assert.ok(data_menu);
...
function get_all_attrs(selection, attr) {
  return selection.nodes().map(function (n) {
...
describe('Draw', function () {
  it('create_reaction', function () {
    var parent_sel = d3_body.append('div');

    // set up
    var d_sel = parent_sel.selectAll('.reaction').data([{ reaction_id: '1234' }, { reaction_id: '5678' }]);

    // run create_reaction
    var e_sel = draw.create_reaction.bind(draw)(d_sel.enter());
    ...
    // check classes
    assert.isTrue(get_all_attrs(e_sel, 'class').every(function (c) {
      return c === 'reaction';
    }));
    // check label
...
var require_helper = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./helpers/require_helper\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var d3_body = __webpack_require__(5);
var trigger_key_event = __webpack_require__(69);
...
var it = __webpack_require__(0).it;
var beforeEach = __webpack_require__(0).beforeEach;
var afterEach = __webpack_require__(0).afterEach;
var assert = __webpack_require__(4).assert;

var Mousetrap = __webpack_require__(18);

describe('KeyManager', function () {
  var key_manager = void 0;
  ...
  it('listens and toggles', function () {
    ...
    key_manager = KeyManager({
      q: { key: 'ctrl+q',
        fn: function fn() {
          pressed_q = true;target = this;
        },
        target: { my: 'target' } },
      p: { key: 'p',
        fn: function fn() {
          return pressed_p = true;
        } }
    });
    // toggle off
  ...
  it('missing key or function', function () {
    ...
    key_manager = KeyManager({ k: { fn: function fn() {
          return {};
        } } });
  ...
  it('check inputs', function () {
    var pressed = 0;
    var iv = false;
    var my_input = { is_visible: function is_visible() {
        return iv;
      } };
    key_manager = KeyManager({ k: {
        key: 'q',
  ...
  it('key listener once', function () {
    key_manager = KeyManager();
    var called = 0;
    key_manager.add_key_listener('x', function () {
      return called++;
    }, true);
    trigger_key_event('x');
  ...
  it('key listener multiple keys', function () {
    key_manager = KeyManager();
    key_manager.ctrl_equals_cmd = true;
    var called = 0;
    key_manager.add_key_listener(['x', 'ctrl+y'], function () {
      return called++;
    });
    trigger_key_event('x');
    assert.strictEqual(called, 1);
  ...
  it('key listener unbind', function () {
    ...
    var unbind_enter = key_manager.add_key_listener('enter', function () {
      called_enter = true;
    });
    var unbind_escape = key_manager.add_key_listener('escape', function () {
      called_escape = true;
    });
    unbind_enter();
    trigger_key_event('enter');
  ...
  it('escape listener', function () {
    key_manager = KeyManager();
    var called_escape = false;
    key_manager.add_escape_listener(function () {
      return called_escape = true;
    });
    trigger_key_event('escape');
  ...
  it('enter listener', function () {
    key_manager = KeyManager();
    var called_enter = false;
    key_manager.add_enter_listener(function () {
      return called_enter = true;
    });
    trigger_key_event('enter');
...
module.exports = function (key, held, selection) {
    ...
    var is_held = function is_held(key) {
...
function matching_reaction(reactions, id) {
  var match = null;
  for (var r_id in reactions) {
    var r = reactions[r_id];
    if (r.bigg_id === id) {
      match = r;
      break;
    }
...
describe('Map', function () {
  ...
  beforeEach(function () {
    ...
    map = Map.from_data(get_map(), svg, null, sel, null, new Settings(set_option, get_option, required_conditional_options), null, true);
  });
  ...
  it('loads without reaction/metabolite data', function () {
    ...
    for (var _id in map.nodes) {
      var node = map.nodes[_id];
      // ids should be strings that eval to integers
      assert.strictEqual(isNaN(_id), false);
      if (node.node_type === 'metabolite') {
        // bigg ids and compartments should be present
        assert.isDefined(map.nodes[_id].bigg_id);
      }
    }

    assert.isTrue(map.has_data_on_reactions);
    for (var _id2 in map.reactions) {
      var reaction = map.reactions[_id2];
    ...
    for (var _id3 in map.nodes) {
      var _node = map.nodes[_id3];
      if (_node.bigg_id_compartmentalized === 'glc__D_p') {
        assert.strictEqual(map.nodes[_id3].data, 3);
      } else {
        assert.strictEqual(map.nodes[_id3].data, null);
      }
    }

    map.apply_reaction_data_to_map(null);
    assert.strictEqual(map.has_data_on_reactions, false);
    for (var _id4 in map.reactions) {
      assert.strictEqual(map.reactions[_id4].data, null);
    }

    map.apply_metabolite_data_to_map(null);
    assert.isFalse(map.has_data_on_nodes);
    for (var _id5 in map.nodes) {
      assert.strictEqual(map.nodes[_id5].data, null);
    }
  });

  it('search index reactions', function () {
    assert.deepEqual(map.search_index.find('glyceraldehyde-3-phosphate dehydrogenase')[0], { type: 'reaction', reaction_id: '1576769' });
    assert.deepEqual(map.search_index.find('GAPD')[0], { type: 'reaction', reaction_id: '1576769' });
    assert.deepEqual(map.search_index.find('b1779')[0], { type: 'reaction', reaction_id: '1576769' });
    assert.deepEqual(map.search_index.find('gapA')[0], { type: 'reaction', reaction_id: '1576769' });
  });

  it('search index metabolites', function () {
    assert.deepEqual(map.search_index.find('Glyceraldehyde-3-phosphate')[0], { type: 'metabolite', node_id: '1576545' });
    assert.deepEqual(map.search_index.find('^g3p_c$')[0], { type: 'metabolite', node_id: '1576545' });
  });

  it('search index text labels', function () {
    assert.deepEqual(map.search_index.find('TEST')[0], { type: 'text_label', text_label_id: '1' });
  });

  it('search index delete', function () {
    // delete reactions
  ...
  it('search index extend reactions', function () {
    map.extend_reactions({ '123456789': { bigg_id: 'EX_glc__D_p',
        name: 'periplasmic glucose exchange',
        gene_reaction_rule: 's0001',
        genes: [{ 'bigg_id': 's0001',
          'name': 'spontaneous' }] } });
    assert.deepEqual(map.search_index.find('EX_glc__D_p')[0], { type: 'reaction', reaction_id: '123456789' });
    assert.deepEqual(map.search_index.find('periplasmic glucose exchange')[0], { type: 'reaction', reaction_id: '123456789' });
    assert.deepEqual(map.search_index.find('s0001')[0], { type: 'reaction', reaction_id: '123456789' });
    assert.deepEqual(map.search_index.find('spontaneous')[0], { type: 'reaction', reaction_id: '123456789' });
  });

  it('search index extend nodes', function () {
    map.extend_nodes({ '123456789': { bigg_id: 'glc__D_p',
        name: 'periplasmic glucose',
        node_type: 'metabolite' } });
    assert.deepEqual(map.search_index.find('^glc__D_p')[0], { type: 'metabolite', node_id: '123456789' });
    assert.deepEqual(map.search_index.find('periplasmic glucose$')[0], { type: 'metabolite', node_id: '123456789' });
  });

  it('search index new/edit text label', function () {
    var id = map.new_text_label({ x: 0, y: 0 }, 'TESTEST');
    assert.deepEqual(map.search_index.find('TESTEST')[0], { type: 'text_label', text_label_id: id });
    map.edit_text_label(id, 'TESTESTEST', false);
    assert.deepEqual(map.search_index.find('^TESTEST$'), []);
    assert.deepEqual(map.search_index.find('TESTESTEST')[0], { type: 'text_label', text_label_id: id });
  });

  it('new_reaction_from_scratch', function () {
    var model_data = { reactions: [{ id: 'acc_tpp',
        metabolites: { acc_c: 1, acc_p: -1 },
    ...
    // find the reaction
    var match = matching_reaction(map.reactions, 'acc_tpp');
    assert.ok(match);
    // gene reaction rule
    assert.strictEqual(match.gene_reaction_rule, model_data.reactions[0].gene_reaction_rule);
  });

  it('new_reaction_from_scratch exchanges', function () {
    ;['uptake', 'secretion'].map(function (direction) {
      var model_data = {
        reactions: [{
          id: 'EX_glc__D_e',
      ...
      // find the reaction
      var match = matching_reaction(map.reactions, 'EX_glc__D_e');
      assert.ok(match);
      // segments
  ...
  it('get_data_statistics accepts numbers or strings as floats; ignores empty strings and nulls', function () {
    var data_reactions = { PGI: [10], GAPD: ['5'], TPI: [''], PGK: [null] };
    map.apply_reaction_data_to_map(data_reactions);
    map.calc_data_stats('reaction');
    assert.deepEqual(map.get_data_statistics(), { reaction: { min: 5, median: 7.5, mean: 7.5,
        Q1: 5, Q3: 10, max: 10 },
      metabolite: { min: null, median: null, mean: null,
        Q1: null, Q3: null, max: null } });
    // metabolites
    var data_metabolites = { g3p_c: [10], fdp_c: ['4'] };
  ...
  it('get_data_statistics uses defaults for no data -- reactions', function () {
  ...
  it('get_data_statistics uses defaults for no data', function () {
    assert.deepEqual(map.get_data_statistics(), {
      reaction: { min: null, median: null, mean: null,
        Q1: null, Q3: null, max: null },
      metabolite: { min: null, median: null, mean: null,
...
describe('SearchIndex', function () {
  ...
  it('insert accepts new records', function () {
    index.insert('123', { 'name': 'a', 'data': 3 }, true);
    assert.ok(index);
  });

  it('insert throws error for malformed records', function () {
    assert.throws(function () {
      index.insert('123', {}, false, true);
    }, 'malformed record');
  });

  it('insert throws error for repeated index', function () {
...
describe('Settings', function () {
  it('initializes', function () {
    ...
    var options = {
      ...
      enable_editing: true,
      reaction_styles: ['color', 'size', 'text'],
      reaction_scale: [{ type: 'min', color: '#c8c8c8', size: 4 }, { type: 'value', value: 0, color: '#9696ff', size: 8 }, { type: 'max', color: '#4b009f', size: 12 }]
    };
    var set_option = function set_option(key, val) {
      options[key] = val;
    };
    ...
    var settings = new Settings(set_option, get_option, Object.keys(options));
    var name = 'reaction_styles';
    var val = ['new_style'];
    var fired = null;
    // set up the callback
    settings.streams[name].onValue(function (val) {
      fired = val;
    });
    // push a new value
...
var require_helper = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./helpers/require_helper\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
var ZoomContainer = require_helper('ZoomContainer');
var d3_transform_catch = require_helper('utils').d3_transform_catch;
...
describe('ZoomContainer', function () {
  ...
  it('initializes', function () {
    ...
    assert.strictEqual(sel.select('.escher-zoom-container').node(), zc.zoom_container.node());
    assert.isTrue(sel.classed('fill-screen-div'));
    assert.strictEqual(sel.select('.escher-3d-transform-container').node(), zc.css3_transform_container.node());
    assert.strictEqual(sel.select('svg').node(), zc.svg.node());
    assert.strictEqual(sel.select('.zoom-g').node(), zc.zoomed_sel.node());
  });

  it('get_size, defined', function () {
    var sel2 = sel.style('width', '100px').style('height', '100px');
    var zc = ZoomContainer(sel2, 'none', true, true);
    var res = zc.get_size();
    assert.deepEqual(res, { width: 100, height: 100 });
  });

  it('get_size, undefined', function () {
    var zc = ZoomContainer(sel, 'none', true, true);
    assert.throws(function () {
      zc.get_size();
  ...
  it('go_to -- no d3 transform', function (done) {
    // no d3 transform
    var zc = ZoomContainer(sel, 'none', false, true);
    zc.go_to(2.0, { x: 10.0, y: -20.5 });
    // check node zoomTransform (__zoom attribute)
    var zoom_transform = d3_zoomTransform(zc.zoom_container.node());
    ...
    _.defer(function () {
      ...
      var transform = d3_transform_catch(zc.zoomed_sel.attr('transform'));
...
describe('data_styles.import_and_check', function () {
  it('checks reaction data', function () {
    var reaction_data = { R1: 0, R2: 4, R3: -12.3 };
    var expected = { R1: [0], R2: [4], R3: [-12.3] };
    var out = data_styles.import_and_check(reaction_data, 'reaction_data');
    assert.deepEqual(out, expected);
  });

  it('checks gene data and funny names', function () {
    var gene_data = { G1ORF: 0, G2ANDHI: 4, 'G3-A': -12.3 };
    var reactions = { '2': { bigg_id: 'reaction_1',
        gene_reaction_rule: '(G1ORF AND G2ANDHI) OR G3-A',
        genes: [{ bigg_id: 'G1ORF', name: '' }, { bigg_id: 'G2ANDHI', name: '' }, { bigg_id: 'G3-A', name: '' }] } };
    var expected = { reaction_1: { G1ORF: [0],
        G2ANDHI: [4],
        'G3-A': [-12.3] } };
    var out = data_styles.import_and_check(gene_data, 'gene_data', reactions);
    assert.deepEqual(out, expected);
  });

  it('checks gene data with multiple sets', function () {
    var gene_data = [{ G1: 0, G2: 4, G3: -12.3 }, { G1: 2, G2: 6 }];
    var reactions = { '4': { bigg_id: 'reaction_2',
        gene_reaction_rule: 'G4',
        genes: [{ bigg_id: 'G4', name: '' }] },
      '3': { bigg_id: 'reaction_1',
        gene_reaction_rule: '(G1 AND G2) OR G3',
        genes: [{ bigg_id: 'G1', name: '' }, { bigg_id: 'G2', name: 'G2_name' }, { bigg_id: 'G3', name: '' }] } };
    var expected = { reaction_2: { G4: [null, null] },
      reaction_1: { G1: [0, 2],
        G2: [4, 6],
        G3: [-12.3, null] } };
    var out = data_styles.import_and_check(gene_data, 'gene_data', reactions);
  ...
  it('checks gene data with nulls', function () {
    var gene_data = [{ G1: 0, G2: 4, G3: -12.3 }, { G1: 2, G2: 6 }];
    var reactions = { '1': { bigg_id: 'reaction_1',
        gene_reaction_rule: '',
        genes: [] } };
    var expected = { reaction_1: {} };
    var out = data_styles.import_and_check(gene_data, 'gene_data', reactions);
    assert.deepEqual(out, expected);
  });
  ...
  it('checks gene data with empty data set', function () {
    var gene_data = {};
    var reactions = { r1: { bigg_id: 'reaction_1',
        gene_reaction_rule: '(G1 AND G2) OR G3',
        genes: [{ bigg_id: 'G1', name: '' }, { bigg_id: 'G2', name: 'G2_name' }, { bigg_id: 'G3', name: '' }] } };
    var expected = { reaction_1: { G1: [null],
        G2: [null],
        G3: [null] } };
    var out = data_styles.import_and_check(gene_data, 'gene_data', reactions);
    assert.deepEqual(out, expected);
...
describe('data_styles.float_for_data', function () {
  it('single', function () {
...
describe('data_styles.text_for_data', function () {
...
describe('data_styles.reverse_flux_for_data', function () {
  it('positive', function () {
    assert.strictEqual(data_styles.reverse_flux_for_data([10]), false);
  });
  it('negative, multiple', function () {
    assert.strictEqual(data_styles.reverse_flux_for_data([-10, 5]), true);
  });
});

describe('data_styles.gene_string_for_data', function () {
  it('single gene with data', function () {
    assert.deepEqual(data_styles.gene_string_for_data('G1', { G1: [-10] }, [{ bigg_id: 'G1', name: 'Gene1' }], ['abs'], 'bigg_id', 'log2_fold'), [{ bigg_id: 'G1', name: 'Gene1', text: 'G1 (-10.0)' }]);
  });
  it('parentheses', function () {
    assert.deepEqual(data_styles.gene_string_for_data('( G1 )', { G1: [-10] }, [{ bigg_id: 'G1', name: 'Gene1' }], ['abs'], 'bigg_id', 'log2_fold'), [{ bigg_id: 'G1', name: 'Gene1', text: '( G1 (-10.0))' }]);
  });

  it('single gene, name identifiers', function () {
    assert.deepEqual(data_styles.gene_string_for_data('( G1 )', { G1: [-10] }, [{ bigg_id: 'G1', name: 'Gene1' }], ['abs'], 'name', 'log2_fold'), [{ bigg_id: 'G1', name: 'Gene1', text: '( Gene1 (-10.0))' }]);
  });

  it('multiple genes, name identifiers, no data', function () {
    assert.deepEqual(data_styles.gene_string_for_data('226_AT2 or 226_AT1 or 226_AT3 or 230_AT1 or 229_AT1', null, [{ name: 'ALDOA', bigg_id: '226_AT2' }, { name: 'ALDOA', bigg_id: '226_AT1' }, { name: 'ALDOA', bigg_id: '226_AT3' }, { name: 'ALDOC', bigg_id: '230_AT1' }, { name: 'ALDOB', bigg_id: '229_AT1' }], [], 'name', 'log2_fold'), [{ name: 'ALDOA', bigg_id: '226_AT2', text: 'ALDOA' }, { name: 'ALDOA', bigg_id: '226_AT1', text: ' or ALDOA' }, { name: 'ALDOA', bigg_id: '226_AT3', text: ' or ALDOA' }, { name: 'ALDOC', bigg_id: '230_AT1', text: ' or ALDOC' }, { name: 'ALDOB', bigg_id: '229_AT1', text: ' or ALDOB' }]);
  });

  it('repeated genes', function () {
    // If the genes object accidentally has repeats, then make sure they are
    // removed.
    assert.deepEqual(data_styles.gene_string_for_data('((b0902 and b0903) or (b0902 and b3114) or (b3951 and b3952) or ((b0902 and b0903) and b2579))', {
    ...
    }, [{ bigg_id: "b0902", name: "b0902" }, { bigg_id: "b0903", name: "b0903" }, { bigg_id: "b2579", name: "b2579" }, { bigg_id: "b0902", name: "b0902" }, { bigg_id: "b0903", name: "b0903" }, { bigg_id: "b0902", name: "b0902" }, { bigg_id: "b3114", name: "b3114" }, { bigg_id: "b3951", name: "b3951" }, { bigg_id: "b3952", name: "b3952" }], ['abs'], 'bigg_id', 'log2_fold'), [{ bigg_id: 'b0902', name: 'b0902', text: '((b0902 (188, 282: 0.583)' }, { bigg_id: 'b0903', name: 'b0903', text: ' and b0903 (1.87e+3, 1.14e+4: 2.62)' }, { bigg_id: 'b0902', name: 'b0902', text: ') or (b0902 (188, 282: 0.583)' }, { bigg_id: 'b3114', name: 'b3114', text: ' and b3114 (5.29, 5.41: 0.0327)' }, { bigg_id: 'b3951', name: 'b3951', text: ') or (b3951 (8.29, 5.97: 0.475)' }, { bigg_id: 'b3952', name: 'b3952', text: ' and b3952 (3.67, 4.29: 0.223)' }, { bigg_id: 'b0902', name: 'b0902', text: ') or ((b0902 (188, 282: 0.583)' }, { bigg_id: 'b0903', name: 'b0903', text: ' and b0903 (1.87e+3, 1.14e+4: 2.62)' }, { bigg_id: 'b2579', name: 'b2579', text: ') and b2579 (5.27e+3, 1.09e+3: 2.28)))' }]);
  });

  it('no data', function () {
    assert.deepEqual(data_styles.gene_string_for_data('( G1 OR G2 )', null, [{ bigg_id: 'G1', name: 'Gene1' }, { bigg_id: 'G2', name: 'Gene2' }], ['abs'], 'name', 'log2_fold'), [{ bigg_id: 'G1', name: 'Gene1', text: '( Gene1' }, { bigg_id: 'G2', name: 'Gene2', text: ' OR Gene2)' }]);
  });
});

describe('data_styles.various methods', function () {
  it('store text for non-numeric data', function () {
    assert.deepEqual(data_styles.float_for_data(['2dmmql8_c + fum_c --> 2dmmq8_c + s'], [], 'log2_fold'), null);
    assert.deepEqual(data_styles.text_for_data(['2dmmql8_c + fum_c --> 2dmmq8_c + s', '8'], null), '2dmmql8_c + fum_c --> 2dmmq8_c + s, 8: (nd)');
    assert.deepEqual(data_styles.reverse_flux_for_data(['2dmmql8_c + fum_c --> 2dmmq8_c + s']), false);
    assert.deepEqual(data_styles.gene_string_for_data('( G1 )', { G1: ['my favorite gene✓', '8'] }, [{ bigg_id: 'G1', name: 'Gene1' }], ['abs'], 'name', 'log2_fold'), [{ bigg_id: 'G1', name: 'Gene1', text: '( Gene1 (my favorite gene✓, 8: nd))' }]);
    assert.deepEqual(data_styles.gene_string_for_data('( G1 )', { G1: ['my favorite gene✓', 'text'] }, [{ bigg_id: 'G1', name: 'Gene1' }], ['abs'], 'name', 'log2_fold'), [{ bigg_id: 'G1', name: 'Gene1', text: '( Gene1 (my favorite gene✓, text))' }]);
  });
});

describe('data_styles.csv_converter', function () {
  it('basic conversion', function () {
    var csv_rows = [['gene', 'v1', 'v2'], ['g1', '10', '20'], ['g2', '15', '25'], ['g3', 'text', 'data']];
    assert.deepEqual(data_styles.csv_converter(csv_rows), [{ 'g1': '10', 'g2': '15', g3: 'text' }, { g1: '20', g2: '25', g3: 'data' }]);
  });
});

describe('data_styles.genes_for_gene_reaction_rule', function () {
  it('finds funny names', function () {
    var rule = '(G1ORF AND G2ANDHI) or YER060W-A OR (G3-A AND G4)';
    assert.deepEqual(data_styles.genes_for_gene_reaction_rule(rule), ['G1ORF', 'G2ANDHI', 'YER060W-A', 'G3-A', 'G4']);
  });

  it('ignores repeats', function () {
    var rule = '((b0902 and b0903) or (b0902 and b3114) or (b3951 and b3952) or ((b0902 and b0903) and b2579))';
    assert.deepEqual(data_styles.genes_for_gene_reaction_rule(rule), ['b0902', 'b0903', 'b3114', 'b3951', 'b3952', 'b2579']);
  });
...
describe('data_styles.evaluate_gene_reaction_rule', function () {
  it('funny gene names, upper and lowercase ANDs', function () {
    var rule = '(G1 AND G2-A) OR (G3ANDHI aNd G4ORF)';
    var gene_values = { G1: [5], 'G2-A': [2], G3ANDHI: [10], G4ORF: [11.5] };
    var out = data_styles.evaluate_gene_reaction_rule(rule, gene_values, 'mean');
    assert.deepEqual(out, [14.25]);
  });

  it('specific bug: repeat', function () {
    var rule = '( YER056C  or  YER060W  or  YER060W-A  or  YGL186C )';
    var gene_values = { "YER056C": ['151'], "YER060W": ['10'],
      "YER060W-A": ['2'], "YGL186C": ['17'] };
    var out = data_styles.evaluate_gene_reaction_rule(rule, gene_values, 'min');
    assert.deepEqual(out, [180]);
  });

  it('single negative', function () {
    var rule = 'YER056C';
    var gene_values = { "YER056C": [-151] };
    var out = data_styles.evaluate_gene_reaction_rule(rule, gene_values, 'min');
  ...
  it('multiple values', function () {
    ...
    var gene_values = { G1: [5, 0], G2: [2, 0], G3ANDHI: [10, 0], G4ORF: [11.5, 6] };
    var out = data_styles.evaluate_gene_reaction_rule(rule, gene_values, 'min');
    assert.deepEqual(out, [12, 0]);
  });

  it('order of operations', function () {
    var rule = '( YEL039C and YKR066C or YJR048W and YKR066C )';
    var gene_values = { YEL039C: ['1'], YKR066C: ['2'], YJR048W: ['4'] };
    var out = data_styles.evaluate_gene_reaction_rule(rule, gene_values, 'min');
    assert.deepEqual(out, [3]);
  });

  it('empty', function () {
    var out = data_styles.evaluate_gene_reaction_rule('', {}, 'min');
    assert.deepEqual(out, [null]);
  });

  it('null values 1', function () {
    var rule = '(G1 AND G2) OR (G3 AND G4)';
    var gene_values = { G1: [5], G2: [2], G3: [''], G4: [null] };
    var out = data_styles.evaluate_gene_reaction_rule(rule, gene_values, 'min');
    assert.deepEqual(out, [2]);
  });

  it('null values 2', function () {
    var rule = '(G1 AND G2) OR (G3 AND G4)';
    var gene_values = { G1: [null], G2: [null], G3: [null], G4: [null] };
    var out = data_styles.evaluate_gene_reaction_rule(rule, gene_values, 'min');
    assert.deepEqual(out, [null]);
  });

  it('null values 3', function () {
    var rule = '(G1 AND G2) OR (G3 AND G4)';
    var gene_values = { G1: [''], G2: [''], G3: [''], G4: [''] };
    var out = data_styles.evaluate_gene_reaction_rule(rule, gene_values, 'min');
    assert.deepEqual(out, [null]);
  });
  ...
  it(' treat nulls as 0', function () {
    var rule = '( YOL096C and YDR204W and YML110C and YGR255C and YOR125C and YGL119W and YLR201C )';
    var gene_values = { "YOL096C": [-9.966],
      "YDR204W": [null],
  ...
  it('extra parentheses', function () {
    var rule = '(( (YJL130C) ) or (YJR109C and YOR303W))';
    var gene_values = { YJL130C: ['-80.0'],
      YJR109C: ['70.5'],
      YOR303W: ['200.5233'] };
...
describe('data_styles.replace_gene_in_rule', function () {
...
describe('data_styles.apply_reaction_data_to_reactions', function () {
  it('for Map.reactions', function () {
...
describe('data_styles.apply_metabolite_data_to_nodes', function () {
  it('for Map.nodes', function () {
...
describe('data_styles.apply_gene_data_to_reactions', function () {
  it('for Map.reactions', function () {
    var reactions = { 238: { bigg_id: 'GAPD',
        ...
        genes: [{ bigg_id: 'b1779',
          name: 'gapA' }],
        segments: { 2: {} } } };
    var data = { GAPD: { b1779: [0, 10] } };
    var out = data_styles.apply_gene_data_to_reactions(reactions, data, [], 'name', 'diff', 'min');
    assert.strictEqual(out, true);
    assert.deepEqual(reactions, { 238: { bigg_id: 'GAPD',
        gene_reaction_rule: 'b1779',
        genes: [{ bigg_id: 'b1779',
