...
describe('data_styles.import_and_check', () => {
  it('checks reaction data', () => {
    const reaction_data = { R1: 0, R2: 4, R3: -12.3 }
    const expected = { R1: [0], R2: [4], R3: [-12.3] }
    const out = data_styles.import_and_check(reaction_data, 'reaction_data')
...
describe('data_styles.float_for_data', () => {
  it('single', () => {
...
describe('data_styles.text_for_data', () => {
  it('positive', () => {
...
describe('data_styles.reverse_flux_for_data', () => {
  it('positive', () => {
...
describe('data_styles.gene_string_for_data', () => {
...
describe('data_styles.various methods', () => {
...
describe('data_styles.csv_converter', () => {
  it('basic conversion', () => {
...
describe('data_styles.genes_for_gene_reaction_rule', () => {
...
describe('data_styles.evaluate_gene_reaction_rule', () => {
  it('funny gene names, upper and lowercase ANDs', () => {
    ...
    const out = data_styles.evaluate_gene_reaction_rule(rule, gene_values, 'mean')
  ...
  it('empty', () => {
    const out = data_styles.evaluate_gene_reaction_rule('', {}, 'min')
...
describe('data_styles.replace_gene_in_rule', () => {
  it('replaces strings', () => {
...
describe('data_styles.apply_metabolite_data_to_nodes', () => {
  it('for Map.nodes', () => {
