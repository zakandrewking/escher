...
function delete_selected () {
  ...
  if (Object.keys(selected_nodes).length >= 1 ||
      Object.keys(selected_text_labels).length >= 1) { this.delete_selectable(selected_nodes, selected_text_labels, true) }
}
