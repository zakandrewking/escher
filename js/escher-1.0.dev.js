...
define('builder/Map',["vis/utils", "lib/d3", "builder/draw", "builder/Behavior", "builder/Scale", "builder/DirectionArrow", "builder/build", "builder/UndoStack", "vis/CallbackManager"], function(utils, d3, draw, Behavior, Scale, DirectionArrow, build, UndoStack, CallbackManager) {
...
define('builder/Input',["lib/d3", "vis/utils",  "lib/complete.ly", "builder/Map", "builder/ZoomContainer"], function(d3, utils, completely, Map, ZoomContainer) {
    /**
     */
...
define('builder/Builder',["vis/utils", "lib/d3", "builder/Input", "builder/ZoomContainer", "builder/Map", "builder/KeyManager", "builder/CobraModel", "builder/Brush"], function(utils, d3, Input, ZoomContainer, Map, KeyManager, CobraModel, Brush) {
    // NOTE
...
define('main',["builder/Builder", "builder/KeyManager"],
       function(bu, km) {
           return { Builder: bu,
		    KeyManager: km };
       });
