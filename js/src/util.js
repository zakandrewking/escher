...
export function set_options(options, defaults, must_be_float) {
...
export function setup_svg(selection, selection_is_svg, fill_screen) {
...
export function remove_child_nodes(selection) {
...
export function load_css(css_path, callback) {
    var css = "";
    if (css_path) {
...
export function load_the_file(t, file, callback, value) {
...
export function load_files(t, files_to_load, final_callback) {
...
export function setup_defs(svg, style) {
    // add stylesheet
...
export function draw_an_object(container_sel, parent_node_selector, children_selector,
...
export function draw_a_nested_object(container_sel, children_selector, object_data_key,
...
export function make_array(obj, id_key) { // is this super slow?
    var array = [];
    for (var key in obj) {
        // copy object
...
export function make_array_ref(obj, id_key) {
...
export function extend(obj1, obj2, overwrite) {
...
export function unique_concat(arrays) {
    var new_array = [];
...
export function unique_strings_array(arr) {
...
export function object_slice_for_ids(obj, ids) {
...
export function object_slice_for_ids_ref(obj, ids) {
...
export function c_plus_c(coords1, coords2) {
...
export function c_minus_c(coords1, coords2) {
    if (coords1 === null || coords2 === null ||
        coords1 === undefined || coords2 === undefined)
        return null;
    return { "x": coords1.x - coords2.x,
...
export function c_times_scalar(coords, scalar) {
    return { "x": coords.x * scalar,
             "y": coords.y * scalar };
}

export function download_json(json, name) {
...
export function load_json(f, callback, pre_fn, failure_fn) {
...
export function load_json_or_csv(f, csv_converter, callback, pre_fn, failure_fn,
                                 debug_event) {
...
export function download_svg(name, svg_sel, do_beautify) {
...
export function rotate_coords_recursive(coords_array, angle, center) {
    var rot = function(c) { return rotate_coords(c, angle, center); };
    return coords_array.map(rot);
}

export function rotate_coords(c, angle, center) {
...
export function get_angle(coords) {
...
export function to_degrees(radians) { return radians*180/Math.PI; }

export function angle_for_event(displacement, point, center) {
...
export function distance(start, end) { return Math.sqrt(Math.pow(end.y-start.y, 2) + Math.pow(end.x-start.x, 2)); }

export function check_undefined(args, names) {
...
export function compartmentalize(bigg_id, compartment_id) {
...
export function random_characters(num) {
...
export function check_for_parent_tag(el, tag) {
...
export function name_to_url(name, download_url) {
...
export function parse_url_components(the_window, options) {
