...
import { builder_embed } from './inline'
...
class Builder {
  ...
  _set_up_menu (menu_selection, map, key_manager, keys, enable_editing,
  ...
  _set_up_button_panel(button_selection, keys, enable_editing,
  ...
  _toggle_direction_buttons(on_off) {
   ...
   */
  _get_keys (map, zoom_container, search_bar, settings_bar, enable_editing, full_screen_button) {
